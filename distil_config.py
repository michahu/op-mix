...
class DistilConfig(TrainingArguments):
    ...
    full_logit_distillation: bool = field(
        default=False,
        metadata={
            "help": "If True, compute distillation loss over the full vocabulary logits rather than only on "
            "sampled tokens. More expensive but can improve distillation quality."
        },
    )
